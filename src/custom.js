...
function zipArrays(date, news, content, uri, url) {
    ...
    for (let i = 0; i < date.length; i++) {
        arr.push({ "titulo": news[i], "data": date[i], "link": `${url.slice(0, -1)}${uri[i]}`, "conteudo": content[i] });//PREENCHENDO ARRAY NOTÍCIAS COM OS DADOS DOS ARRAYS CITADOS ACIMA, ATRAVÉS DO MÉTODO PUSH()
